        ...
        *,
        ...
        self.db.execute(
            ...
            INSERT INTO observations (
                ...
                selection_score, rationale, summary, category
            )
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NULL, NULL, ?, ?)
            """,
            (
    ...
    def compute_flagship_selection(self) -> None:
        for slug in self.flagship_dimensions:
            ...
            self.coverage_report[slug] = {
                ...
                "selected_shortfall_to_required_min": max(0, min(required_min, len(eligible_rows)) - len(selected_rows)),
